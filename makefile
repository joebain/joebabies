...
LDLIBS_R = -Wl,-Bstatic -llua -lluabind -Wl,-Bdynamic -lGL -lGLU -lX11 -lXmu -lXi -lm -lSDL -lSDL_mixer
LDLIBS_D = -llua -lluabindd -lGL -lGLU -lX11 -lXmu -lXi -lm -lSDL -lSDL_mixer
SOURCES = src/Block.cpp src/Display.cpp src/Face.cpp src/Main.cpp src/ModelLoader.cpp src/Obj.cpp src/Texture.cpp src/Vector2f.cpp src/Vector2i.cpp src/Vector3f.cpp src/Vector3i.cpp src/Vertex.cpp src/World.cpp src/Controller.cpp src/Camera.cpp src/Block3D.cpp src/Block2D.cpp src/Floor.cpp src/Timer.cpp src/Sky.cpp src/Block2DText.cpp src/BlockFactory.cpp src/LuaBinder.cpp src/Buttons.cpp src/AudioMixer.cpp src/AudioFile.cpp
